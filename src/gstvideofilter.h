...
#define GST_VIDEO_FILTER_CLASS()    (G_TYPE_CHECK_CLASS_CAST((klass), GST_TYPE_VIDEO_FILTER, GstVideoFilterClass))

#define GST_IS_VIDEO_FILTER(obj)    (G_TYPE_CHECK_INSTANCE_TYPE((obj), GST_TYPE_VIDEO_FILTER))
#define GST_IS_VIDEO_FILTER_CLASS   (G_TYPE_CHECK_CLASS_TYPE((klass), GST_TYPE_VIDEO_FILTER))
